<?php
	...
	$sql = $conn->query("SELECT * FROM loaisanpham ");
	$numRow = $sql->num_rows;
?>
<?php 
		...
		<div class="pd-ltr-20">
			...
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h2 style="margin: 10px 0">Danh sách loại sản phẩm</h2>
						<div class="row">
							<div class=" col-lg-12 ">	
								<a
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus ">Mã loại sản phẩm</th>
							...
							<tbody>
								<?php 
									...
									?>
									<tr>
										<td  class="table-plus text-right"><?php echo $row['ma_loaisp']?></td>
