		...
		<div class="pd-ltr-20">
			...
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h2 style="margin: 10px 0">Danh sách thành viên</h2>
						<div class="row">
							<div class=" col-lg-12 ">	
								<a
					...
					<div class="pb-20 ">
						...
						<table id="example1"class="table data-table table-striped table-bordered" style="width:100%">
							<thead>
								<tr>
									<th scope="col" class="table-plus all">Mã thành viên</th>
						...
						<form>
							<div class="row">
								...
								<div class="col-md-6 ">
									...
									<div class="form-group">
										...
										<input  id="ngaybd_md" class="form-control date-picker" placeholder="Chọn ngày bắt đầu làm" type="text">
									</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Chức vụ</label>
										<select  id="cvu_md" class="custom-select col-12" >
								...
								<div class="col-md-6 ">
									<div class="form-group">
										<label >Ngày sinh</label>
										<input id="ngaysinh_md" class="form-control date-picker" placeholder="Chọn ngày sinh" type="text">
									</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Giới tính</label>
										<select  id="gioitinh_md" class="custom-select col-12" >
...
<script>
	...
	var masppp;
	<?php 
		$sqlP =  $conn->query(" SELECT * FROM user "); 
		$rows = array();
	...
	?>;
		...
		table=$('#example1').DataTable( {
			...
			$("#example1").on('click','.edit_sp',function(){
				...
				$.ajax({
                    type: 'POST',
                    url: 'ajax_thanhvien.php',
                    datatype: "json",
                   // async: false,
				  	data:{data},
                    success: function (data) {
						var data = $.parseJSON(data);
						document.getElementById('ten_thanhvien_md').value=data.ten_nv;
						document.getElementById('ngaybd_md').value=data.ngaybd;
						document.getElementById('sdt_md').value=data.sdt;
						document.getElementById('email_md').value=data.email;
						document.getElementById('cvu_md').value=data.chuc_vu;
						document.getElementById('ngaysinh_md').value=data.ngaysinh;
						document.getElementById('gioitinh_md').value=data.gioitinh;
						document.getElementById('diachi_md').value=data.diachi;
						// masppp=data.ma_sp;
						// console.log(data);
    					// table.row.add( newRow ).draw();
                    },
