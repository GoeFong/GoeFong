...
if(empty($_SESSION['user']) OR $_SESSION['user'] != 'admin'){
	...
	$sql = $conn->query("SELECT * FROM nhasanxuat ");
	$numRow = $sql->num_rows;
?>
<?php 
		...
		<div class="pd-ltr-20">
			...
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h2 style="margin: 10px 0">Danh sách nhà sản xuất</h2>
						<div class="row">
							<div class=" col-lg-12 ">	
								<a
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus  ">Mã nhà sản xuất</th>
							...
							<tbody>
								<?php 
									...
									?>
									<tr>
										<td  class="table-plus text-right"><?php echo $row['ma_nsx']?></td>
